...
A primeira execução do workflow em Linux aprovou 15 testes e falhou somente na igualdade binária do checkpoint histórico: diferença absoluta máxima de `2,27652813e-09`, atribuível à plataforma/BLAS. Nenhuma tolerância foi alterada. Como o checkpoint normativo foi produzido e validado em Windows, o workflow passou a usar runner Windows para conservar a comparação bit a bit.
